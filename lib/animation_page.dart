...
class _AnimationPageState extends State<AnimationPage>
  ...
  Widget _buildResponsiveAnimationArea(BuildContext context) {
    ...
    // Reserve space for ad bar above animation for very small screens
    final isVerySmallScreen = screenWidth < 360;
    final adBannerHeight = screenHeight * 0.08; // Same as main screen bannerHeight

    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        if (isVerySmallScreen)
          SizedBox(height: adBannerHeight), // Reserve space for ad bar
        // Add extra space above animation for all screens
              ...
              child: !connected
                  ? AnimatedBuilder(
                      ...
                      builder: (context, child) {
                        ...
                        // Move animation and GIF just a little less down
                  ...
                  : AnimatedBuilder(
                      animation: _controller,
                      builder: (context, child) {
                        // Move animation and image just a little less down
                        return Transform.translate(
                          offset: Offset(0, screenHeight * 0.035),
                          child: Stack(
                            alignment: Alignment.center,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                width: 1.5,
                                color: speedBlockColor.withOpacity(0.3),
                                margin: EdgeInsets.symmetric(horizontal: sidePadding * 0.7),
                              ),
                              // Download section
                              Row(
                                children: [
